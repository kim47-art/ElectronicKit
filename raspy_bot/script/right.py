...
set_allmotor([55,90,55,90,90,90,90,90],0.5)

for i in range(5):
    set_allmotor([55,70,55,90,90,90,90,70],0.3)
    set_allmotor([90,70,55,90,90,90,55,70],0.3)
    set_allmotor([90,90,55,90,90,90,55,90],0.3)
    set_allmotor([55,90,90,70,55,70,90,90],0.3)
